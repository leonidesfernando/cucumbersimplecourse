Feature: Menu Management
  Background: Setup a menu item
    Given I have a menu item with a name "Chicken Sandwich" and price $15.5
    When I add that menu item
    Then Menu item with name "Chicken Sandwich" should be added
  @SmokeTest
  Scenario: Add a menu item
    Given I have a menu item with a name "Cucumber Sandwich" and price $20.05
    When I add that menu item
    Then Menu item with name "Cucumber Sandwich" should be added

  @RegularTest
  Scenario: Add another menu item
    Given I have a menu item with a name "Cucumber Salad" and price 10.99
    When I add that menu item
    Then Menu item with name "Cucumber Salad" should be added

  @NightlyBuildTest @RegularTest
  Scenario: Add third menu item
    Given I have a menu item with a name "Chicken Sandwich" and price $15.59
    When I add that menu item
